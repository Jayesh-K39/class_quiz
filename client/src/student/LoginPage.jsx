	...
	return(
		<div className={`${bodyStyle}`}>
			<div className={`holder ${holderStyle}`}>
				<span className='font-bold p-3 '>LOGIN</span>
				<input className={`${inputStyle}`} placeholder='Enter your name here' />
				<input className={`${inputStyle}`} type='password' placeholder='Enter the password  here' />
			</div>

			<Link to='/question' className={`${btnStyle}`}> CONFIRM </Link>
		</div>
	)
}
